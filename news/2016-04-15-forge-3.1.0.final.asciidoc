...
* *JavaTargetFacet*: We introduced a JavaTargetFacet in order to provide the path to the compiled sources. This is useful when used together with ClassLoaderFacet to build a 
