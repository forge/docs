...
image::../images/using/new-project.png[title="Creating new project" align="center"]
...
image::../images/using/jpa-setup.png[title="Setup JPA" align="center"]

The next step you need to configure your connection settings:

image::../images/using/configure-connection-settings.png[title="Configuring Connection Settings" align="center"]
...
image::../images/using/jpa-new-entity.png[title="Creating a new Entity" align="center"]
...
image::../images/using/new-field.png[title="Creating a new field in Entity" align="center"]
...
image::../images/using/new-enum.png[title="Creating a new Enum" align="center"]
...
image::../images/using/new-enum-const.png[title="Creating a new Enum Constant" align="center"]
...
image::../images/using/new-enum-jpa-field.png[title="Creating a new Enum field in Entity" align="center"]
...
image::../images/using/new-relationship.png[title="Creating a new relationship" align="center"]

If you choose Next instead of Finish, You can configure your relationship:

image::../images/using/relationship-configuration.png[title="Configuring relationship" align="center"]
...
image::../images/using/setup-constraint.png[title="Setup Bean Validation" align="center"]
...
image::../images/using/add-constraint.png[title="Adding Constraint" align="center"]
...
image::../images/using/add-notnull-constraint.png[title="Adding NotNull Constraint" align="center"]
...
image::../images/using/configure-constraint.png[title="Configuring Constraint" align="center"]
...
image::../images/using/faces-scaffold.png[title="Configuring Faces Scaffold" align="center"]

If you haven't selected the Java EE 7 stack when creating the project, click Next to configure the Faces Scaffold:

image::../images/using/faces-configuration-scaffold.png[title="Setup Facets" align="center"]
...
image::../images/using/select-jpa-entities.png[title="Selecting JPA entities" align="center"]
...
image::../images/using/rest-setup.png[title="Configuring REST" align="center"]
...
image::../images/using/rest-entities.png[title="Generating RESTEndpoints from JPA entities" align="center"]
...
image::../images/using/addon-install.png[title="Installing an Addon" align="center"]
...
image::../images/using/as-setup.png[title="AS Setup" align="center"]

Click next to configure the _Install directory_, _Port_ and so on:

image::../images/using/as-configuration.png[title="Configuration AS" align="center"]

Now let's build the application:

Open the Forge wizard (Ctrl + 4 or CMD + 4 on Mac) and choose _Build_:

image::../images/using/build.png[title="Building" align="center"]

Now start server with the _AS: Start_ command and deploy application with _AS: Deploy_:
	
image::../images/using/as-deploy.png[title="Deploying" align="center"]
