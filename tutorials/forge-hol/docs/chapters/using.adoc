...
Open the Forge wizard (Ctrl + 4 or CMD + 4 on Mac) and choose _JPA: New Field_, select the _Book_ as Target Entity. Enter _language_ as Field name, select _org.cdbookstore.model.Language_ as Field Type and mark _Many-to-One_ as Relationship Type and click Finish (or Next):
