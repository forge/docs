...
This is the end of our hands on lab, but it's the begining of a new journey: a world of productivity... even with Java EE.
We hope you enjoyed it and that it helped you in discovering and learning more about JBoss Forge. 
