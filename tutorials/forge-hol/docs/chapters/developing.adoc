...
[source, console]
----
$ project-new --named envers --type forge-addon --top-level-package org.jboss.forge.addon
----

Important::If you are running Forge 3.0.0.BetaX, replace `--type forge-addon` with `--type addon`
