...
The idea is that you leave this hands on lab (HoL) with a good understanding of what JBoss Forge is, what it is not, and how it can help you in your projects. Then, you'll have your entire time to investigate a bit more and, hopefully,  http://forge.jboss.org/community[contribute] ;o)
